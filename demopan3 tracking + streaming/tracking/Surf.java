...
public class Surf {
	...
	private double vxfinal,vyfinal;
	...
	public ArrayList<Integer> filtreVector(){
		...
		double vx=0,vy=0,comptVNonFiltre=0,lx=0,ly=0;
		vxfinal=0;
		vyfinal=0;
		comptVFiltre=0;      
	...
	public final void printImages(Mat imageArrivee, int w, int h, JFrame jFrame){
		{
			copyOfImageArrivee=imageArrivee;
			//finalCadre=new Cadre(copyOfImageArrivee, (cadreDepart.getXCoin()+(vectorOfMove.get(0))), (cadreDepart.getYCoin()+vectorOfMove.get(1)),w,h);
