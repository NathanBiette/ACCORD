...
[xbatterie, xmelodie, xbasse, xaccompagnement, xglobal, N] = load_audio(nb_essai, n, delta, 0);
...
for j=1:leng
    ...
    [Xprim, compteurs(j)] = multiplication_resolution3(V, Wprim, H, beta, epsilon);
...
if save_result==1
  main_code = fileread('multiplication_resolution3.m');
  ...
  save('../results/compteurs.mat', 'compteur_pseudoinv2', 'compteur_pseudoinv1', 'compteur_nmf');
end;
